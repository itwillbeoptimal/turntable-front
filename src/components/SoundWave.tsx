...
const Wave = styled.svg`
  ...
  #Line_1 { animation: ${pulse} 1s infinite; animation-delay: 0.15s; }
  #Line_2 { animation: ${pulse} 1s infinite; animation-delay: 0.30s; }
  #Line_3 { animation: ${pulse} 1s infinite; animation-delay: 0.45s; }
  #Line_4 { animation: ${pulse} 1s infinite; animation-delay: 0.60s; }
  #Line_5 { animation: ${pulse} 1s infinite; animation-delay: 0.75s; }
  #Line_6 { animation: ${pulse} 1s infinite; animation-delay: 0.90s; }
  #Line_7 { animation: ${pulse} 1s infinite; animation-delay: 1.05s; }
  #Line_8 { animation: ${pulse} 1s infinite; animation-delay: 1.20s; }
  #Line_9 { animation: ${pulse} 1s infinite; animation-delay: 1.35s; }
`;

// Loader 컴포넌트 정의
const SoundWave = () => (
    <WaveContainer>
        <Wave id="wave" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 38.05">
